...
export default class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        if (!this.registry.has('goldCount')) this.registry.set('goldCount', 1500000)
        if (!this.registry.has('gemCount')) this.registry.set('gemCount', 200)
        ...
        // fire.trail = this.add.particles(0, 0, 'flares', {
        //     frame: 'yellow',
        //     lifespan: 3800,
        //     speed: { min: 50, max: 100 },
        //     angle: { min: -90 - 10, max: -90 + 10 }, // летят вверх, +-10°
